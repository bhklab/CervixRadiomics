...
save_obj(results,f'/Users/josephmarsilla/Google Drive/notebooks/Cervix/Data/OLD_CNRADREGNORM_{date}_{max_iter}.pkl')
save_obj(label,f'/Users/josephmarsilla/Google Drive/notebooks/Cervix/Data/OLD_CNLABELS_{date}_{max_iter}.pkl')
