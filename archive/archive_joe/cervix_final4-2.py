...
def get_signatures(train_set_, test_set_, train_set_target_,  test_set_target_, solutions=100, data='both'):
      ...
      for l in range(start,end):
        ...
        if data == 'both':
            drop_cols = ['shape_VoxelVolume']
            fixed = ['cohort', 'figo2018']
        else:
            drop_cols = ['shape_VoxelVolume', 'cohort']
            fixed = ['figo2018']
...
#             choice = ['shape_VoxelVolume']
        ...
        if data == 'both':
            if l == 2:
              chosen0 = ['event','time', 'cohort', 'figo2018']
              chosen = ['event','time', 'cohort', 'figo2018']
              chosen2 = ['event','time', 'cohort', 'figo2018']
            else:
              chosen0 = ['event','time', 'cohort', 'figo2018','Signature0']
              chosen = ['event','time', 'cohort', 'figo2018', 'Signature']
              chosen2 = ['event','time', 'cohort', 'figo2018', 'Signature2']
        else:
            if l == 1:
              chosen0 = ['event','time', 'figo2018']
              chosen = ['event','time', 'figo2018']
              chosen2 = ['event','time', 'figo2018']
            else:
              chosen0 = ['event','time', 'figo2018','Signature0']
              chosen = ['event','time',  'figo2018', 'Signature']
              chosen2 = ['event','time', 'figo2018', 'Signature2']
...
save_obj(results,f'/Users/josephmarsilla/Google Drive/notebooks/Cervix/Data/-STAGEREGNORM_{date}_{max_iter}_{d}.pkl')
