...
def get_signatures(train_set_, test_set_, train_set_target_,  test_set_target_, solutions=100, data='both'):
      ...
      for l in range(start,end):
        ...
        if data == 'both':
            drop_cols = ['figo2018']
            fixed = ['cohort', 'shape_VoxelVolume']
        else:
            drop_cols = ['figo2018', 'cohort']
            fixed = ['shape_VoxelVolume']
        ...
        doc['feature_list_1'] = feature_list0
        doc['feature_list_100'] = feature_list
        doc['feature_list_500'] = feature_list2

        if data == 'both':
            doc['num_features'] = l - 2 # in addition to volume...
            set_features = ['cohort', 'shape_VoxelVolume']
            exclude = ['cohort', 'time', 'event','shape_VoxelVolume', 'figo2018']
        else:
            doc['num_features'] = l - 1
            set_features = ['shape_VoxelVolume']
            exclude = ['time', 'event','shape_VoxelVolume', 'figo2018']
...
#             choice = ['shape_VoxelVolume']
        ...
        if data == 'both':
            if l == 2:
              chosen0 = ['event','time', 'cohort', 'shape_VoxelVolume']
              chosen = ['event','time', 'cohort', 'shape_VoxelVolume']
              chosen2 = ['event','time', 'cohort', 'shape_VoxelVolume']
            else:
              chosen0 = ['event','time', 'cohort', 'shape_VoxelVolume','Signature0']
              chosen = ['event','time', 'cohort', 'shape_VoxelVolume', 'Signature']
              chosen2 = ['event','time', 'cohort', 'shape_VoxelVolume', 'Signature2']
            ...
            if l == 1:
              chosen0 = ['event','time', 'shape_VoxelVolume']
              chosen = ['event','time', 'shape_VoxelVolume']
              chosen2 = ['event','time', 'shape_VoxelVolume']
            else:
              chosen0 = ['event','time', 'shape_VoxelVolume','Signature0']
              chosen = ['event','time',  'shape_VoxelVolume', 'Signature']
              chosen2 = ['event','time', 'shape_VoxelVolume', 'Signature2']
...
save_obj(results,f'/Users/josephmarsilla/Google Drive/notebooks/Cervix/Data/-VOLREGNORM_{date}_{max_iter}_{args.choose_data}.pkl')
