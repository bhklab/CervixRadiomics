...
def get_signatures(train_set_, test_set_, train_set_target_,  test_set_target_):
      ...
      for l in range(1,6):
        ...
        s1 = pymrmre.mrmr_ensemble(features=train_set_.drop(columns=['shape_VoxelVolume', 'figo2018', 'cohort']), targets = train_set_target_.drop(columns=['time','figo2018']),
                                    solution_length=l, solution_count=1)
...
save_obj(results,f'/Users/josephmarsilla/Google Drive/notebooks/Cervix/Data/NORONLY-RADREGNORM_{date}_{max_iter}.pkl')
