...
def get_args():
    ...
    parser.add_argument('--choose-data', default='both', type=str,
                        help='both is default. (TCGA == 1) (Norway == 0)')
...
def get_signatures(train_set_, test_set_, train_set_target_,  test_set_target_, solutions=100, data='both'):
      ...
      for l in range(start, end):
        ...
        if data == 'both':
            drop_cols = []
            fixed = ['cohort','shape_VoxelVolume', 'figo2018']
            penalizer = False
            # sol = 1
        else:
            drop_cols = ['cohort']
            fixed = ['shape_VoxelVolume', 'figo2018']
            penalizer = 0.01
        ...
        doc['num_features'] = l - 3 # in addition to volume...
    ...
    #             choice = ['shape_VoxelVolume']
        ...
        if data=='both':
            if l == 3:
              chosen0 = ['event','time', 'cohort','shape_VoxelVolume', 'figo2018']
              chosen = ['event','time', 'cohort','shape_VoxelVolume', 'figo2018']
              chosen2 = ['event','time', 'cohort','shape_VoxelVolume', 'figo2018']
            else:
              chosen0 = ['event','time', 'cohort', 'shape_VoxelVolume', 'figo2018', 'Signature0']
              chosen = ['event','time', 'cohort', 'shape_VoxelVolume', 'figo2018',  'Signature']
              chosen2 = ['event','time', 'cohort', 'shape_VoxelVolume', 'figo2018', 'Signature2']
        else:
            if l == 2:
              chosen0 = ['event','time', 'shape_VoxelVolume', 'figo2018']
              chosen = ['event','time', 'shape_VoxelVolume', 'figo2018']
              chosen2 = ['event','time', 'shape_VoxelVolume', 'figo2018']
            else:
              chosen0 = ['event','time', 'shape_VoxelVolume', 'figo2018', 'Signature0']
              chosen =  ['event','time', 'shape_VoxelVolume', 'figo2018',  'Signature']
              chosen2 = ['event','time', 'shape_VoxelVolume', 'figo2018', 'Signature2']
...
save_obj(results,f'/Users/josephmarsilla/Google Drive/notebooks/Cervix/Data/-VOLSTAGEREGNORM_{date}_{max_iter}_{d}.pkl')
